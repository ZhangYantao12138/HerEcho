 ...
 */
export const VIEWPOINT_MAPPING = [
 ...
 * @returns 视角描述
 */
export function getViewpointDescriptionByKey(promptKey = '') {
    if (!promptKey)
        return VIEWPOINT_DESCRIPTIONS.DEFAULT;
    return VIEWPOINT_DESCRIPTIONS[promptKey] || VIEWPOINT_DESCRIPTIONS.DEFAULT;
}
