 ...
 */
export function generatePlayerPrompt(character, message) {
    // 获取玩家视角角色
    const viewpointRelation = VIEWPOINT_MAPPING.find(vp => vp.characterId === character.id);
 ...
 */
function generateDefaultPlayerPrompt(character, message) {
 ...
 */
export function generateAutoReplyPrompt(character, message) {
